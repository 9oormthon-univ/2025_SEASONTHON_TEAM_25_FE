...
class DubbleBtnModal extends StatelessWidget {
  final String text;
  final String description;
  final String buttonText1;
  final String buttonText2;
  final VoidCallback clickBtn1;
  final VoidCallback clickBtn2;
  const DubbleBtnModal({
    super.key,
    required this.text,
    required this.description,
    required this.buttonText1,
    required this.buttonText2,
    required this.clickBtn1,
    required this.clickBtn2,
  });
