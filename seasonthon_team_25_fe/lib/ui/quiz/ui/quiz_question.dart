...
//           color:
//               selected
//                   ? AppColors.primarySky.withValues(alpha: 0.5)
//                   : AppColors.secondarySk.withValues(alpha: 0.5),
...
//                         : AppColors.primarySky.withValues(alpha: .25),
//               ),
//               borderRadius: BorderRadius.circular(24),
//               color:
//                   isSel
//                       ? AppColors.primarySky.withValues(alpha: 0.08)
//                       : Colors.transparent,
//             ),
//             child: Row(
...
//                 Text(
//                   '${i + 1}. ',
//                   style: AppTypography.l500.copyWith(color: AppColors.primarySky),
//                 ),
//                 Expanded(
//                   child: Text(
//                     options[i],
...
//       decoration: BoxDecoration(
//         color: AppColors.primarySky.withValues(alpha: .10),
//         borderRadius: BorderRadius.circular(12),
