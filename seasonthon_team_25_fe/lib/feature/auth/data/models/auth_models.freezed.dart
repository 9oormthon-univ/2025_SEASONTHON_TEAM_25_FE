...
mixin _$SignUpResponse {
 ...
 int get id; String get email; String get role; String get status; bool get characterCreated; DateTime get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,email,role,status,characterCreated,createdAt);

@override
String toString() {
  return 'SignUpResponse(id: $id, email: $email, role: $role, status: $status, characterCreated: $characterCreated, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 int id, String email, String role, String status, bool characterCreated, DateTime createdAt
});
...
/// Create a copy of SignUpResponse
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? email = null,Object? role = null,Object? status = null,Object? characterCreated = null,Object? createdAt = null,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String email,  String role,  String status,  bool characterCreated,  DateTime createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SignUpResponse() when $default != null:
return $default(_that.id,_that.email,_that.role,_that.status,_that.characterCreated,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String email,  String role,  String status,  bool characterCreated,  DateTime createdAt)  $default,) {final _that = this;
switch (_that) {
case _SignUpResponse():
return $default(_that.id,_that.email,_that.role,_that.status,_that.characterCreated,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String email,  String role,  String status,  bool characterCreated,  DateTime createdAt)?  $default,) {final _that = this;
switch (_that) {
case _SignUpResponse() when $default != null:
return $default(_that.id,_that.email,_that.role,_that.status,_that.characterCreated,_that.createdAt);case _:
  return null;
...
class _SignUpResponse implements SignUpResponse {
  const _SignUpResponse({required this.id, required this.email, required this.role, required this.status, required this.characterCreated, required this.createdAt});
...
/// Create a copy of SignUpResponse
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? email = null,Object? role = null,Object? status = null,Object? characterCreated = null,Object? createdAt = null,}) {
...
mixin _$LoginResponse {
 ...
 String get accessToken; String get refreshToken; String get tokenType; int get expiresIn; LoginUserResponse get user;
...
@useResult
$Res call({
 String accessToken, String refreshToken, String tokenType, int expiresIn, LoginUserResponse user
});
...
$LoginUserResponseCopyWith<$Res> get user {
  ...
  return $LoginUserResponseCopyWith<$Res>(_self.user, (value) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String accessToken,  String refreshToken,  String tokenType,  int expiresIn,  LoginUserResponse user)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LoginResponse() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String accessToken,  String refreshToken,  String tokenType,  int expiresIn,  LoginUserResponse user)  $default,) {final _that = this;
switch (_that) {
case _LoginResponse():
return $default(_that.accessToken,_that.refreshToken,_that.tokenType,_that.expiresIn,_that.user);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String accessToken,  String refreshToken,  String tokenType,  int expiresIn,  LoginUserResponse user)?  $default,) {final _that = this;
switch (_that) {
case _LoginResponse() when $default != null:
return $default(_that.accessToken,_that.refreshToken,_that.tokenType,_that.expiresIn,_that.user);case _:
  return null;
...
class _LoginResponse implements LoginResponse {
  const _LoginResponse({required this.accessToken, required this.refreshToken, required this.tokenType, required this.expiresIn, required this.user});
...
@override final  LoginUserResponse user;
...
@override $LoginUserResponseCopyWith<$Res> get user;
...
class _RefreshResponse implements RefreshResponse {
  const _RefreshResponse({required this.accessToken, required this.refreshToken, required this.tokenType, required this.expiresIn});
