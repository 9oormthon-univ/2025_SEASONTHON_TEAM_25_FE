...
class _QuizApi implements QuizApi {
  ...
  @override
  Future<DailyQuizResponse> getDailyQuizzes() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<DailyQuizResponse>(
    ...
    late DailyQuizResponse _value;
    try {
      _value = DailyQuizResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
